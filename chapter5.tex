...
\begin{figure}[H]
    ...
    \subfigure[The first image]{
        \includegraphics[width=0.5\linewidth]{figs/my_pic.png} % Include your first plot
        \label{fig:plot1}
    }
    \hfill
    \subfigure[Second image ]{
        \includegraphics[width=0.5\linewidth]{figs/my_pic.png} % Include your second plot
        \label{fig:plot2}
    }
